...
class BasicTranslatorTest extends \PHPUnit_Framework_TestCase {
	private static $translator;

	public static function setUpBeforeClass() {
		self::$translator = new BasicTranslator(__DIR__ . '/locale', 'default');
	...
	public function testConstructor() {
		$domain = 'client';
		$translator = new BasicTranslator(__DIR__ . '/locale', $domain);
